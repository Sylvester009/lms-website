            ...
            {chapters.map((chapter, index) => (
              ...
              >
                {(provided) => (
                  <div
                    className={cn(
                      "flex items-center gap-x-2 bg-orange-200 border-orange-200 text-orange-700 rounded-md mb-4 text-sm",
                      chapter.isPublished &&
                  ...
                  >
                    <div className={cn(
                        ...
                        chapter.isPublished && "border-orange-200 hover:bg-orange-200"
                    )}
